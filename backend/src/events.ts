...
export type EventType = "search" | "parse" | "assistant" | "transcribe" | "verify" | "unlock" | "upgrade" | "deal_created" | "deal_countered" | "deal_accepted" | "deal_declined" | "feed" | "market" | "quote";
